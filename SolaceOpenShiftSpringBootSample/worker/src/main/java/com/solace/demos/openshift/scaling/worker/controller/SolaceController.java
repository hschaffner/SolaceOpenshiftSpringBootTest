...
package com.solace.demos.openshift.scaling.worker.controller;
...
import com.solace.demos.openshift.scaling.worker.model.WorkInstance;
import com.solace.demos.openshift.scaling.worker.model.WorkResponse;
...
public class SolaceController {
    ...
    class DemoMessageListener implements XMLMessageListener {
        ...
        public void onReceive(BytesXMLMessage request) {
            ...
            // message type property with value "DEMO_REQUEST"
            SDTMap propertiesMap = request.getProperties();
            if (propertiesMap == null || !propertiesMap.containsKey(MSG_TYPE_HEADER) || request.getReplyTo() == null
            ...
            try {
                ...
                // Search in the message body for the "work load" and simulate
                // work by sleeping
                // for that time.
                ...
                // Build response
                WorkResponse workResponse = new WorkResponse(workInstance.getId(), delayInMSec,
                        workInstance.getSendTime(), clientName, workInstance.getJobId());
